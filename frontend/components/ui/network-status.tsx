        ...
        <Button variant="ghost" size="sm" className={`h-8 px-2 ${className}`}>
          <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-1">
              ...
              <span className="text-xs font-medium">GemmaFinOS GemmaChain Chain</span>
            </div>
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between text-sm">
              ...
              <div className="flex items-center gap-1">
                ...
                <span className="font-medium">GemmaFinOS GemmaChain Chain</span>
              </div>
            </div>
          ...
          {networkStatus === 'deprecated' && (
            <Alert variant="destructive">
              ...
              <AlertDescription className="text-xs">
                This network is deprecated. Please switch to the GemmaFinOS Private Subnet.
              </AlertDescription>
            </Alert>
          )}
