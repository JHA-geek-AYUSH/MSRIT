...
// This presentation component supports the richer legacy research-message shape.
// Keep it decoupled from the simplified compliance-chat message contract.
type Message = any;
...
// Hardcoded GemmaFinOS Agents map with names and roles
const AGENTS_META = [
  {
    ...
    return (
      <div className="flex items-center justify-center h-full text-gray-500">
        <div className="text-center">
          <div className="text-6xl font-light text-black mb-4">GemmaFinOS</div>
    ...
    <div className="space-y-6">
      ...
      {isLoading && (
        <div className="flex items-center space-x-2 text-gray-500">
          ...
          <span>GemmaFinOS is thinking...</span>
        </div>
      )}
    </div>
  );
...
function DAOVerdictMessage({ message }: { message: Message }) {
  ...
  const displayAgents = AGENTS_META.map((meta) => {
    const found = outputs.find((o: any) => o.agent === meta.key);
