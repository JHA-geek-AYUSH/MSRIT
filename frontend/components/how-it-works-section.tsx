    ...
    <section className="py-16 bg-[#F8F3EE]">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          <h2
            className="text-3xl md:text-4xl lg:text-5xl font-display font-light text-[#2A2A2A] mb-8 tracking-wide leading-tight"
          >
        ...
        <div className="grid lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
          ...
          <div className="lg:col-span-1">
            <div className="mb-6">
              <h3
                className="text-xl font-display font-semibold text-[#2A2A2A] mb-4"
              >
                VERIFIED ATTORNEYS & CHARTERED ACCOUNTANTS
              </h3>
              <p
                className="font-body text-[#8B7355] leading-relaxed mb-6"
              >
              ...
              <button
                className="font-body bg-[#8B7355] hover:bg-[#7A6449] text-white px-6 py-2 text-sm font-medium transition-colors duration-300"
              >
                Learn More
              </button>
            </div>
          ...
          <div className="lg:col-span-1">
            <div className="bg-[#8B4513] text-white p-8 -2xl h-full">
              ...
              <p
                className="font-body text-white/90 mb-8 leading-relaxed"
              >
              ...
              <div className="space-y-6">
                <div>
                  <h4 className="font-body font-semibold mb-2">
