        ...
        <CardContent className="space-y-4">
          <Alert className="bg-green-100 border-green-300">
            ...
            <AlertDescription className="text-green-800">
              ...
              {notarizationProof.is_private_subnet && " The verification is stored on GemmaFinOS's private subnet for enhanced privacy."}
              {!notarizationProof.is_private_subnet && " All transactions are paid by GemmaFinOS servers - no cost to you."}
            </AlertDescription>
          </Alert>
          ...
          {notarizationProof.is_private_subnet && (
            <Alert className="bg-purple-50 border-purple-200">
              ...
              <AlertDescription className="text-purple-800">
                This verification is stored on GemmaFinOS's private subnet. Only authorized parties can access the transaction details.
                <strong> No charges apply to your account</strong> - all blockchain costs are covered by GemmaFinOS.
              </AlertDescription>
            </Alert>
          )}
        </CardContent>
      ...
      <CardContent className="space-y-4">
        <Tabs value={usePrivateSubnet ? "private" : "public"} onValueChange={(value) => setUsePrivateSubnet(value === "private")}>
          ...
          <TabsContent value="private" className="space-y-4">
            <Alert className="bg-purple-50 border-purple-200">
              <Lock className="h-4 w-4" />
              <AlertDescription className="text-purple-800">
                <strong>GemmaFinOS Private Subnet</strong> - Enhanced privacy with server-paid transactions. No wallet connection required.
              </AlertDescription>
            </Alert>
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              ...
              <div>
                ...
                <span className="ml-2 font-medium">GemmaFinOS Server</span>
              </div>
            </div>
          </TabsContent>
          ...
          <TabsContent value="public" className="space-y-4">
            <Alert className="bg-blue-50 border-blue-200">
              ...
              <AlertDescription className="text-blue-800">
                <strong>Public Network</strong> - Legacy support for GemmaChain Fuji testnet. Server-paid transactions.
              </AlertDescription>
            </Alert>
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              <div>
                <span className="text-brown-600">Network:</span>
                <span className="ml-2 font-medium">GemmaChain Fuji</span>
              </div>
              <div>
                <span className="text-brown-600">Privacy:</span>
        ...
        <div className="space-y-3">
            ...
            <div className="text-xs text-brown-500 space-y-1">
              <div className="flex justify-between">
                ...
                <span className="text-brown-700">
                  {usePrivateSubnet ? currentNetwork.displayName : 'GemmaChain Fuji'}
                </span>
              </div>
              <div className="flex justify-between">
                <span>Transaction Cost:</span>
                <span className="text-green-600 font-medium">Paid by GemmaFinOS</span>
              </div>
              <div className="flex justify-between">
                <span>Your Cost:</span>
          ...
          <Alert className="bg-blue-50 border-blue-200">
            <Info className="h-4 w-4" />
            <AlertDescription className="text-blue-800">
              <strong>No wallet connection needed.</strong> GemmaFinOS's servers handle all blockchain transactions and pay all associated costs. 
