...
const features = [
  ...
  },
  {
    ...
    description: 'Every research run is cryptographically verified and published on GemmaChain for immutable audit trails.'
  },
  {
    icon: Zap,
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl  font-bold text-brown-900 mb-4">
            Why Legal Professionals Choose GemmaFinOS
          </h2>
