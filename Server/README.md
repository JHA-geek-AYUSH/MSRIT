...
Blockchain and Vector Database Server for GemmaFinOS (GemmaFin OS)

## Overview

The GemmaFinOS Server is a comprehensive service focused on:
...
- **Subnet Notarization**: Publish Merkle roots to private GemmaChain subnet
...
- Private GemmaChain subnet (optional for development)
