# GemmaFinOS Server Frontend

Modern React/Next.js frontend for GemmaFinOS Server blockchain and vector database operations.
...
- Private GemmaChain subnet (optional)
...
NEXT_PUBLIC_APP_NAME="GemmaFinOS Server"
```
