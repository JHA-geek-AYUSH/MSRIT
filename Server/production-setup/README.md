# GemmaFinOS Phase 2 - Production Subnet Deployment

This directory contains all the scripts and configuration needed to deploy the GemmaFinOS private GemmaChain Subnet for production use.
...
│   ├── subnet-config.json    # GemmaChain CLI subnet config
