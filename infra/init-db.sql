-- Initialize GemmaFinOS Database
...
-- Grant permissions
GRANT ALL ON SCHEMA public TO gemmaFin;
GRANT ALL PRIVILEGES ON DATABASE gemmaFin_db TO gemmaFin;
...
COMMENT ON DATABASE gemmaFin_db IS 'GemmaFinOS - GenAI Co-Counsel Database';
