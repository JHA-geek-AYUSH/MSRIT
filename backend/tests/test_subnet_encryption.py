...
class TestConfigurationHandling:
    ...
    def test_missing_salt_fallback(self):
        ...
        with patch('app.subnet.encryption.get_settings') as mock_settings:
            mock_settings.return_value.SUBNET_MASTER_KEY_B64 = 'YWFhYWFhYWFhYWFhYWFhYWFhYWFhYWFhYWFhYWFhYWE='
            mock_settings.return_value.FHE_SALT_OR_LABEL_SALT_BASE64 = None
    ...
    def test_invalid_master_key_length(self):
        ...
        with patch('app.subnet.encryption.get_settings') as mock_settings:
            mock_settings.return_value.SUBNET_MASTER_KEY_B64 = 'c2hvcnQ='  # base64("short") - too short
...
class TestRealWorldScenarios:
    ...
    def test_large_audit_data(self):
        ...
        # Create large audit data (similar to real GemmaFinOS run)
        large_audit = {
            "version": "gemmaFin-audit-v1",
