...
class GemmaFinOSError(Exception):
    """Base exception class for GemmaFinOS-specific errors"""
...
class ValidationError(GemmaFinOSError):
    """Input validation errors"""
    pass


class AuthenticationError(GemmaFinOSError):
    """Authentication and authorization errors"""
    pass


class RateLimitError(GemmaFinOSError):
    """Rate limiting errors"""
    pass


class InsufficientCreditsError(GemmaFinOSError):
    """Billing and credit errors"""
    pass


class ProcessingError(GemmaFinOSError):
    """Document processing and OCR errors"""
    pass


class RetrievalError(GemmaFinOSError):
    """Retrieval and search errors"""
    pass


class AgentError(GemmaFinOSError):
    """Agent execution errors"""
    pass


class VerificationError(GemmaFinOSError):
    """Verification and validation errors"""
    pass


class ExportError(GemmaFinOSError):
    """Export generation errors"""
    pass


class StorageError(GemmaFinOSError):
    """Storage and file operation errors"""
    pass


class DatabaseError(GemmaFinOSError):
    """Database operation errors"""
    pass


class ExternalServiceError(GemmaFinOSError):
...
def safe_async_operation(operation_name: str, error_handler: Optional[callable] = None):
    ...
    def decorator(func):
        ...
        async def wrapper(*args, **kwargs):
            ...
            except GemmaFinOSError as e:
                # Handle known GemmaFinOS errors
...
class GlobalExceptionHandler:
    ...
    @staticmethod
    async def handle_gemmaFin_exception(request: Request, exc: GemmaFinOSError):
        """Handle GemmaFinOS-specific exceptions"""
