...
def _add_pdf_header(story, styles, run_id: str, payload: Dict[str, Any]):
    ...
    story.append(Paragraph("Generated by GemmaFinOS Legal AI Assistant", styles['subtitle']))
...
def _add_pdf_footer(story, styles, run_id: str):
    ...
    footer_text = f"Generated by GemmaFinOS Legal AI • Report ID: {run_id} • {datetime.now().strftime('%Y-%m-%d %H:%M')}"
