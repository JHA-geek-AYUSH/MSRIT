...
def _add_header_section(doc, run_id: str, payload: Dict[str, Any]):
    ...
    # Subtitle
    subtitle = doc.add_paragraph('Generated by GemmaFinOS Legal AI Assistant')
...
def _add_footer_section(doc, run_id: str):
    ...
    footer = doc.add_paragraph(f'Generated by GemmaFinOS Legal AI • Report ID: {run_id} • {datetime.now().strftime("%Y-%m-%d %H:%M")}')
