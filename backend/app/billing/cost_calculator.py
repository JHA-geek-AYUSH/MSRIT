...
class CostCalculator:
    """Calculate costs for various GemmaFinOS operations"""
    ...
    def calculate_query_cost(self, query: str, mode: str, filters: Dict[str, Any] = None) -> Dict[str, Any]:
        ...
        # Development mode: drastically reduce costs so demos don't run out of credits
        try:
            from app.core.config import get_settings
            if get_settings().ENVIRONMENT == "development":
                total_cost = max(1, total_cost // 10)
        except Exception:
            pass
